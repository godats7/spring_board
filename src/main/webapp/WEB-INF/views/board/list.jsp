...
<div class="table_wrap">
	...
	<div class="search_wrap">
        ...
        <select name="type">
                ...
                <option value="TC" <c:out value="${pageMaker.criteria.type eq 'TC'?'selected':'' }"/>>제목 + 내용</option>
                <option value="TW" <c:out value="${pageMaker.criteria.type eq 'TW'?'selected':'' }"/>>제목 + 작성자</option>
                <option value="TCW" <c:out value="${pageMaker.criteria.type eq 'TCW'?'selected':'' }"/>>제목 + 내용 + 작성자</option>
            </select>
